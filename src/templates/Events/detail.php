...
<div class="container">
    ...
    <div class="row">
        <div class="column label">ユーザー参加情報</div>
        <div class="column">
    ...
    <div class="row">
        <div class="column label">参加表明</div>
        <div class="column">
    ...
    <div class="row">
        <div class="column label">参加者一覧</div>
        <div class="column">
