...
<?php $user_response_state = (!is_null($event->user_response_state)) ? Configure::read('response_states')[$event->user_response_state] : null; ?>
    ...
    <div class="event-item-inner">
        <div class="event-item-tags">
            ...
            <?php if($event->participants_limit <= 0): ?>
                <div class="state-tag disp-iblock" , style="background-color: #5f9ea0;">
                    人数無制限
                </div>
            <?php endif; ?>
        </div>
        ...
        <div class="location">
            <?= $event->location->display_name ?>おあかきさしまむめ
        </div>
